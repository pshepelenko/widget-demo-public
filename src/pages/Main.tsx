        ...
        <div className="bg-gray-100 w-full md:w-1/4"  >
          <div className="flex flex-col" >
            ...
            <div className="overflow-y-auto overscroll-contain" style={isMobile ? {height: '500px'} : {height: '700px'} } >
              <div className="w-full grid place-items-center mt-5 mb-5">
                <button className="p-2  flex items-center text-xs font-medium border rounded shadow-sm focus:none text-secondary border-secondary  hover:border-opacity-100"> 
                  ...
                  <div className="ml-2"> EXPORT SESSION SHORTLIST </div>
                </button>
              </div>
              ...
              <div className="w-full grid place-items-center mt-5 mb-5">
                <button className="p-2  flex items-center text-xs font-medium border rounded shadow-sm focus:none text-white bg-secondary border-secondary  hover:border-opacity-100"> 
                  <div className="ml-2"> ADD TO CART </div>
               </button>
              </div>

              <div className="w-full flex flex-col grid place-items-center mt-5 mb-5">
                More description
