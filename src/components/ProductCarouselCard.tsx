...
const ProductCarouselCard: FC<IProps> = ({ product, image, handleRemoveClick }): JSX.Element => {
  return (
    <div className="w-full h-80">
      ...
      >
        <svg product-id={product.id.toString()} id="splasup-shortlist-remove-icon" className="mt-1 mr-1" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => handleRemoveClick(product.id)}>
